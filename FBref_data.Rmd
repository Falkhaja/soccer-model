...
```{r new_fit}
fit_1 <- stan_glm(data = newfit_epl_results_pivoted,
 ...
 fit_2 <- stan_glm(data = newfit_epl_results_pivoted,
  ...
  fit_model_PLtable <- tbl_regression(fit_2, 
               intercept = TRUE, 
               estimate_fun = function(x) style_sigfig(x, digits = 3)) %>%
